                ...
                <div class="p-4 border-b border-gray-100 bg-white/40 rounded-t-3xl sticky top-0 z-10 backdrop-blur-md">
                    <div class="flex flex-col sm:flex-row gap-3">
                        <div class="relative flex-1">
                            ...
                            <input type="text" wire:model.live.debounce.400ms="search" class="pl-10 w-full rounded-xl border-gray-200 bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all placeholder-gray-400 shadow-sm"
