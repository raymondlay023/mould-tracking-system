<div class="space-y-6">
    <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex justify-between items-center">
        <div>
            <h1 class="text-xl font-bold text-gray-900">Start Production Run</h1>
    ...
    <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 space-y-4">
        <div>
            ...
            <select wire:model="startMachineId" class="w-full rounded-lg border-gray-300 text-lg focus:border-blue-500 focus:ring-blue-500">
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Operator Name (Optional)</label>
            <input type="text" wire:model="startOperatorName" class="w-full rounded-lg border-gray-300 text-lg focus:border-blue-500 focus:ring-blue-500">
