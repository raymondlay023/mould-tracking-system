<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <button class="bg-white border border-slate-200 text-slate-700 p-4 rounded-xl shadow-sm flex flex-col items-center justify-center gap-2 active:scale-95 transition-transform">
